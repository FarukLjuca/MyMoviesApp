...
public class MoviesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void actorInfoClick(View view) {
        ActorFragment actorFragment = (ActorFragment) getSupportFragmentManager().findFragmentByTag(AppString.actorFragmentTag);
    ...
    public void rateMovieVideo(View view) {
        VideoFragment videoFragment = (VideoFragment) getSupportFragmentManager().findFragmentByTag(AppString.videoFragmentTag);
